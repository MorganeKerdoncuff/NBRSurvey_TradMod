...
- Even small conventional intensification steps, such as low artificial fertilizer use, can negatively affect species richness without systematically increase yield (@beckmannConventionalLandUse2019). Though this is context-dependent, we can consider that within our survey area we do have a gradient of intensity (ref to SI table with land use data)
...
- the **slope**: the fjord landscape alternates between hills and dips. The steepness of a slope affects the soil erosion potential as well as the water streaming: a sharp hill will suffer from regular soil renewal and nutrient depletion (@klimekPlantSpeciesRichness2007a), while a flat area will store higher water and carbon  content [REF].
