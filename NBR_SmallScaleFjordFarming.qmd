...
Beetle specimens were collected with dung-baited pitfall traps located on the destructive quadrats, for a total of 12 pitfall traps per site. The traps were made of white plastic cups of 750 mL (**DIAMETER**) filled to 1/4 with salted water and a drop of neutral detergent to break water surface tension [REF]. The traps were set into the ground with the edge at the same level as the soil surface and covered with a metal grid with a [**MESH SIZE**] of cm^2^. A ball of cow dung, previously frozen, was then placed on the middle of the grid roof in a way that it would leave at least 3 cm of empty space around the edge of the cups for the beetles to fall in. The traps were left on site for one full week before retrieval.
...
| Variable set                                    | Variable                            | Effect                                                  | Included in grass model | Included in forb model | Included in beetle model | References                                                           |
|-------------------------------------------------|-------------------------------------|---------------------------------------------------------|-------------------------|------------------------|--------------------------|----------------------------------------------------------------------|
| Fjord system                                    | Elevation                           | Local climate, temperature, precipitations              | YES                     | YES                    | YES                      | [@zelnikPlantSpeciesDiversity2013]                                   |
|                                                 | Annual precipitations               | Local climate                                           | YES                     | YES                    | YES                      |                                                                      |
|                                                 | Average maximum July temperature    | Local climate                                           | YES                     | YES                    | YES                      |                                                                      |
|                                                 | Average minimum January temperature | Local climate                                           | NO◦                     | NO◦                    | NO◦                      |                                                                      |
|                                                 | Distance to sea                     | Local climate, wind, precipitations                     | YES                     | YES                    | YES                      |                                                                      |
| Landscape within 1 km radius around the   field | Forest proportion                   | Plant seed flow, phytophagous beetle flow               | YES                     | YES                    | YES                      |                                                                      |
|                                                 | Wetland proportion                  | Hygrophilous beetle flow                                | NO*                     | YES                    | YES                      |                                                                      |
|                                                 | Cultivated land proportion          | Forb seed flow, productivity                            | YES                     | YES                    | YES                      |                                                                      |
|                                                 | Outfield proportion                 | Forb seed flow, grass seed flow, productivity           | YES                     | YES                    | NO*                      |                                                                      |
|                                                 | Infield proportion                  | Forb seed reservoir, grass seed reservoir, productivity | YES                     | YES                    | YES                      |                                                                      |
| Grazing management                              | Type of livestock                   | Grazing patterns, fodder selection, dung type           | YES                     | YES                    | YES                      |                                                                      |
|                                                 | Size of livestock flock             | Grazing intensity, grazing rotations, grazing patterns  | NO*                     | NO*                    | YES                      |                                                                      |
|                                                 | Stocking density                    | Grazing intensity                                       | YES                     | YES                    | YES                      |                                                                      |
|                                                 | Farm infield area                   | Grazing intensity, grazing rotations                    | YES                     | YES                    | YES                      |                                                                      |
|                                                 | Field size                          | Grazing intensity, grazing patterns                     | YES                     | YES                    | YES                      |                                                                      |
| Fine-scale environment                          | Slope                               | Water streaming, erosion, heat load                     | YES                     | YES                    | YES                      | [@klimekPlantSpeciesRichness2007a; @zelnikPlantSpeciesDiversity2013] |
|                                                 | Aspect                              | Heat load                                               | YES                     | NO*                    | YES                      |                                                                      |
|                                                 | Bulk density                        | Soil compaction                                         | YES                     | YES                    | YES                      |                                                                      |
|                                                 | Penetration rate                    | Soil compaction, root density                           | YES                     | YES                    | YES                      |                                                                      |
|                                                 | Loss of ignition                    | Plant nutrient uptake, soil compaction                  | NO◦                     | NO◦                    | NO                       |                                                                      |
|                                                 | Nitrogen content                    | Plant nutrients                                         | NO◦                     | NO◦                    | NO                       | [@zelnikPlantSpeciesDiversity2013]                                   |
|                                                 | Phophorus content                   | Plant nutrients                                         | YES                     | YES                    | NO                       | [@zelnikPlantSpeciesDiversity2013]                                   |
|                                                 | pH                                  | Plant nutrients                                         | YES                     | YES                    | NO                       |                                                                      |
|                                                 | Humus content                       | Soil moisture, plant nutrients                          | NO◦                     | NO◦                    | NO◦                      |                                                                      |
|                                                 | Soil moisture                       | Soil moisture, hygrophilous beetle niche                | NO◦                     | NO◦                    | NO◦                      |                                                                      |
|                                                 | Bryophyte cover                     | Soil moisture, hygrophilous beetle niche                | NO                      | NO                     | YES                      |                                                                      |
|                                                 | Litter cover                        | Soil moisture, litter-dwelling beetle niche             | NO                      | NO                     | NO*                      |                                                                      |
|                                                 | Exposed ground cover                | Structural diversity, sun-loving beetle niche           | NO                      | NO                     | NO*                      |                                                                      |
|                                                 | Mean vegetation height              | Structural diversity                                    | NO                      | NO                     | YES                      |                                                                      |

## Data analysis

All statistical and ordination analyses were performed on R (v.4.3.0) with R-Studio (v.2023.03.1+446) [@rcoreteamLanguageEnvironmentStatistical2022]. The canonical correlation analysis and the related statistical were made with the packages CCA [*ref*] and CCP [*ref*]. All data with in-field replication were summarized at the site level, by sum for beetle captures and by average for all other variables.

[selection plant & beetle data]

We investigated the relationships between sets of drivers and community data with Canonical Correlation Analysis [@hotellingRelationsTwoSets1992]. 

### Data preparation and verification assumptions

#### Selection plant species and beetle families

#### Data transformation

- livestock qualitative into dummy quantitative
- data scaling

#### Verification for non-colinearity

Prior to analysis, we verified for the non-colinearity of variables within driver sets with paired plots: when two variables had a correlation coefficient equal to or over 0.8 [**REF**], if applicable only the one with the highest in-site replication was kept, if not the choice was made according to ecological significance. Variables rejected because of colinearity are indicated in [**table**].
<!-- For soil data, bulk density was strongly correlated with moisture (0.86), LOI (0.8), Humus (0.8) and nitrogen (0.82). -->

#### Verification for non-linear relationships

As canonical correlation analysis tests for linear relationships between sets of variables, we did preliminary investigation for clear non-linear interactions between individual drivers and community variables. Ordination scores of grass, forb and beetle community data were extracted from Detrended Correspondance Analyses (DCA), or subsequent Principal Component Analyses (PCA) if the first axis length of the DCA was under 2 units. The significance of the linear

- DCA & PCA when DCA axis<2
- extraction species scores
- linear model species scores against individual driver
- plot of residuals of the linear model -> 
- posthoc tukey on residuals.

### Canonical correlation

Final set of variables described in [**table**]. For descriptive statistics of the drivers, check table in SI.
