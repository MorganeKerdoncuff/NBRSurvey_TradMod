...
- the **soil nutrients**: nitrogen and phosphorous are the most studied plant limiting factors in agronomy [REF]. As high concentrations favor competitive fodder species, we can expect a correlation between nutrient load and dominant grass communities.
...
All data collection related to soil physical properties or chemistry was done in destructive quadrats.
...
We measured the distance between the field and the closer fjord on Norge i bilder.


### Field management data

Information on the grazing management were collected from the farmers with interviews conducted from October 2021 to January 2022 [SURVEY APPENDIX]. Some farmers could not or did not want to reply to our survey, we therefore completed the missing values with a similar interview serie conducted in 2018 [REF TO MARGIT MASTER THESIS].
...
If the number of replicates was similar, then we chosed according to ecological significance.
