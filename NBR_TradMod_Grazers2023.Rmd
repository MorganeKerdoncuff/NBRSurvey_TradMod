...
Complementary of bulk density, indicative of soil compaction & root density.
...
## Canonical correlation analaysis


### Variable selection
The canonical correlation cannot be done for a matrix with the number of variables exceeding the number of observations.
Therefore the plant community dataset was shrunk down from 275 to 29 species, by keeping species which total mean cover across all sites was above 15%.
