...
In this context, the ecosystem service framework offers a useful toolbox for facilitating conservation measures, as it encompass the contribution to an extensive range of benefits beyond productivity-oriented perspectives.
Semi-natural habitats can be assessed and compared not only according to their productivity but to their contribution to an extensive range of benefits [@geertsemaActionableKnowledgeEcological2016; @germanRelationshipsMultipleAspects2017].
...
- Lower forage production can thus be weighted against greater contributions to regulating services [@eldridgeGlobalContributionSoil2023; @walmsleyEnsuringLongtermProvision2021].
...
In this paper, we relied on the land use types inherited from the traditional infield-outfield system to investigate synergies and trade-offs between indicators of diversity (plant richness), aboveground production (aboveground biomass), soil biological activity (Collembola and Acari abundances) and soil carbon content (Loss on ignition) across the fjord landscape of the Nordhordland UNESCO Biosphere Reserve.
...
```{r tbl-varsum}
#| tbl-cap: "Summary statistics of indicator variables."
#| message: false
#| warning: false
...
## No consistent trends of soil mesofauna abundance
