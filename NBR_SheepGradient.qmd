...
The UNESCO Nordhordland Biosphere Reserve (NBR) stretches up to 100 km from the North Sea through the fjord system of Western Norway [@kalandNordhordlandBiopshereReserve2018]. The fjord geomorphology, which grows from flat coastal areas towards sharp mountain slopes inland, creates a tight oceanic-subalpine climatic gradient from west to east with decreasing temperatures and increasing precipitations [@ketzlerClimateNorway2021]. Thus, mean annual precipitation can vary more than twice as much (from 1550 to 4800 mm) between the coast and the upland, and mean July temperature can drop by almost half (from 15.9 to 8.3C), along with increasing annual temperature range [**norsk klimaservicesenter**].
